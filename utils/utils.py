...
class Cluster:
    ...
    def __init__(self, ):
        ...
        xm = torch.linspace(0, 4, 4096).view(1, 1, -1).expand(1, 2048, 4096)
        ym = torch.linspace(0, 2, 2048).view(1, -1, 1).expand(1, 2048, 4096)
    ...
    def cluster_mots_wo_points(self, prediction, n_sigma=1, threshold=0.5, min_pixel=128, with_uv=False, thresh=0.5):
