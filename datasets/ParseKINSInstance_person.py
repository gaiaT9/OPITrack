    ...
    for ann in anns_:
        if ann['category_id'] in [1, 2]:
            ...
            if ann['category_id'] == 2:
                ...
                inmodal_ann_mask = maskUtils.decode(ann['inmodal_seg'])
                inmodal[inmodal_ann_mask > 0] = not_pedestrian + count
...
if __name__ == '__main__':
    src_img_path = kittiRoot + "training/image_02_det"
    src_gt7_path = kittiRoot + "kitti_instances_train.json"
    save_path = kittiRoot + "training/person_KINS/"
    ...
    src_img_path = kittiRoot + "testing/image_02_det"
    src_gt7_path = kittiRoot + "kitti_instances_val.json"
    save_path = kittiRoot + "/testing/person_KINS/"
    mkdir_if_no(save_path)
